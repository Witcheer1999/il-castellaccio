...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Il Castellaccio  &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.2" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://il-castellaccio-1.local/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://il-castellaccio-1.local/wp-admin/?simply_static_page=899">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to Il Castellaccio </a>		</p>
			</div>
			<script src="./wp-content/plugins/stratum/assets/js/editor-panel.min.js?ver=1.3.14" id="stratum-editor-panel-js-js"></script>
<script id="essential-blocks-blocks-localize-js-extra">var EssentialBlocksLocalize = {"eb_plugins_url":".\/\/wp-content\/plugins\/essential-blocks\/","eb_wp_version":"6.2","eb_version":"4.0.8","eb_admin_url":".\/\/wp-admin\/","rest_rootURL":".\/\/wp-json\/","ajax_url":".\/\/wp-admin\/admin-ajax.php","nft_nonce":"5f3bda452f"};</script>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"05ed213301"};</script>
